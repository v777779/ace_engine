...
#ifndef FOUNDATION_ACE_ADAPTER_PREVIEW_OSAL_IMAGE_PERF_PREVIEW_H
#define FOUNDATION_ACE_ADAPTER_PREVIEW_OSAL_IMAGE_PERF_PREVIEW_H
...
#endif // FOUNDATION_ACE_ADAPTER_PREVIEW_OSAL_IMAGE_PERF_PREVIEW_H
