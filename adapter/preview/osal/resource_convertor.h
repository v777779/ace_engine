...
#ifndef FOUNDATION_ACE_ADAPTER_PREVIEW_OSAL_RESOURCE_CONVERTOR_H
#define FOUNDATION_ACE_ADAPTER_PREVIEW_OSAL_RESOURCE_CONVERTOR_H
...
#endif // FOUNDATION_ACE_ADAPTER_PREVIEW_OSAL_RESOURCE_CONVERTOR_H