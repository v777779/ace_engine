...
#ifndef FOUNDATION_ACE_ADAPTER_PREVIEW_OSAL_MOUSE_STYLE_OHOS_H
#define FOUNDATION_ACE_ADAPTER_PREVIEW_OSAL_MOUSE_STYLE_OHOS_H
...
#endif // FOUNDATION_ACE_ADAPTER_PREVIEW_OSAL_MOUSE_STYLE_OHOS_H