...
#ifndef FOUNDATION_ACE_ADAPTER_OHOS_OSAL_RESOURCE_CONVERTOR_H
#define FOUNDATION_ACE_ADAPTER_OHOS_OSAL_RESOURCE_CONVERTOR_H
...
#endif // FOUNDATION_ACE_ADAPTER_OHOS_OSAL_RESOURCE_CONVERTOR_H