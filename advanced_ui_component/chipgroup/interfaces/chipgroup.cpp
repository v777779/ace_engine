    ...
    const char** buf, int* buflen)
{
    ...
    if (buflen != nullptr) {
        *buflen = _binary_chipgroup_abc_end - _binary_chipgroup_abc_start;
    }
}
 ...
 * Module define
 */
static napi_module ChipGroupModule = {
    .nm_version = 1,
    .nm_flags = 0,
    .nm_filename = nullptr,
    .nm_modname = "arkui.advanced.ChipGroup",
    .nm_priv = ((void*)0),
    .reserved = { 0 },
};
 ...
 */
extern "C" __attribute__((constructor)) void ChipGroupRegisterModule(void)
{
    napi_module_register(&ChipGroupModule);
}
