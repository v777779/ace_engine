...
export class LanguageUtil {
    static getLanguageCode() {
        let systemLanguage = i18n.System.getAppPreferredLanguage() || i18n.System.getSystemLanguage();
    ...
    static getENSimplifiedLanguage(language) {
        try {
...
LanguageUtil.LANGUAGE_MAP = new Map([['zh', 'zh-cn'], ['en', 'en-us']]);