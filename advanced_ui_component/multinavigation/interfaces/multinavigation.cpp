 ...
 * Module define
 */
static napi_module MultiNavigationModule = {
    .nm_version = 1,
    .nm_flags = 0,
    .nm_filename = nullptr,
    .nm_modname = "arkui.advanced.MultiNavigation",
    .nm_priv = ((void*)0),
    .reserved = { 0 },
};
 ...
 */
extern "C" __attribute__((constructor)) void MultiNavigationRegisterModule(void)
{
    napi_module_register(&MultiNavigationModule);
}
