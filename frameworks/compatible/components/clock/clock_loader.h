...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CLOCK_CLOCK_LOADER
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CLOCK_CLOCK_LOADER

#include "compatible/components/component_loader.h"

namespace OHOS::Ace {

class ClockLoader : public ComponentLoader {
public:
    ClockLoader() = default;
    ~ClockLoader() = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CLOCK_CLOCK_LOADER