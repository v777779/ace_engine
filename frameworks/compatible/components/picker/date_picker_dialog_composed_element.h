...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_PICKER_DATE_PICKER_DIALOG_COMPOSED_ELEMENT_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_PICKER_DATE_PICKER_DIALOG_COMPOSED_ELEMENT_H
...
public:
    ...
    ~DatePickerDialogComposedElement() override = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_PICKER_DATE_PICKER_DIALOG_COMPOSED_ELEMENT_H
