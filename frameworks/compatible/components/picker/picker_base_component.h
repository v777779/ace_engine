...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_PICKER_PICKER_BASE_COMPONENT_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_PICKER_PICKER_BASE_COMPONENT_H

#include "compatible/components/picker/picker_animation_controller.h"
...
class ACE_FORCE_EXPORT PickerBaseComponent : public SoleChildComponent {
