...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_USE_COMPONENT_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_USE_COMPONENT_H
...
class SvgUseComponent : public ComponentGroup {
    DECLARE_ACE_TYPE(SvgUseComponent, ComponentGroup);

public:
    SvgUseComponent();
    explicit SvgUseComponent(const std::list<RefPtr<Component>>& children);
    ~SvgUseComponent() override = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_USE_COMPONENT_H
