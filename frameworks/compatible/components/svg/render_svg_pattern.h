...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_RENDER_SVG_PATTERN_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_RENDER_SVG_PATTERN_H
...
public:
    ...
    double ParseUnitsAttr(const Dimension& attr, double value) const;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_RENDER_SVG_PATTERN_H
