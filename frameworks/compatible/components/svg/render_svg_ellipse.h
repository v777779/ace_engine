...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_RENDER_SVG_ELLIPSE_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_RENDER_SVG_ELLIPSE_H

#include "frameworks/compatible/components/svg/render_svg_base.h"

namespace OHOS::Ace {

class RenderSvgEllipse : public RenderSvgBase {
    DECLARE_ACE_TYPE(RenderSvgEllipse, RenderSvgBase);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_RENDER_SVG_ELLIPSE_H
