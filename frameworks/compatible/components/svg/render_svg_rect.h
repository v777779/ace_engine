...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_RENDER_SVG_RECT_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_RENDER_SVG_RECT_H

#include "frameworks/compatible/components/svg/render_svg_base.h"

namespace OHOS::Ace {

class RenderSvgRect : public RenderSvgBase {
    DECLARE_ACE_TYPE(RenderSvgRect, RenderSvgBase);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_RENDER_SVG_RECT_H
