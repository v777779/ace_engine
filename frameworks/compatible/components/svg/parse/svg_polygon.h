...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_POLYGON_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_POLYGON_H
...
class SvgPolygon : public SvgNode {
    DECLARE_ACE_TYPE(SvgPolygon, SvgNode);
...
private:
    RefPtr<SvgPolygonComponent> component_;
};

} // namespace OHOS::Ace

#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_POLYGON_H