...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_CIRCLE_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_CIRCLE_H
...
class SvgCircle : public SvgNode {
    DECLARE_ACE_TYPE(SvgCircle, SvgNode);
...
private:
    RefPtr<SvgCircleComponent> component_;
};

} // namespace OHOS::Ace

#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_CIRCLE_H