...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_PATTERN_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_PATTERN_H

#include "frameworks/compatible/components/svg/parse/svg_node.h"
#include "frameworks/compatible/components/svg/svg_pattern_component.h"

namespace OHOS::Ace {

class SvgPattern : public SvgNode {
    DECLARE_ACE_TYPE(SvgPattern, SvgNode);
...
private:
    RefPtr<SvgPatternComponent> component_;
};

} // namespace OHOS::Ace

#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_PATTERN_H