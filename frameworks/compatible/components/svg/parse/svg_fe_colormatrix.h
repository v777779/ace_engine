...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_FE_COLORMATRIX_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_FE_COLORMATRIX_H
...
class SvgFeColorMatrix : public SvgNode {
    DECLARE_ACE_TYPE(SvgFeColorMatrix, SvgNode);
...
private:
    RefPtr<SvgFeColorMatrixComponent> component_;
};

} // namespace OHOS::Ace

#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_FE_COLORMATRIX_H
