...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_LINE_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_LINE_H

#include "frameworks/compatible/components/svg/parse/svg_node.h"
#include "frameworks/compatible/components/svg/svg_line_component.h"

namespace OHOS::Ace {

class SvgLine : public SvgNode {
    DECLARE_ACE_TYPE(SvgLine, SvgNode);
...
private:
    RefPtr<SvgLineComponent> component_;
};

} // namespace OHOS::Ace

#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_LINE_H