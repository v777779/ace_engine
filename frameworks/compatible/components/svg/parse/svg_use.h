...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_USE_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_USE_H
...
class SvgUse : public SvgNode {
    DECLARE_ACE_TYPE(SvgUse, SvgNode);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_USE_H