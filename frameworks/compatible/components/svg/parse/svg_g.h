...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_G_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_G_H
...
class SvgG : public SvgNode {
    DECLARE_ACE_TYPE(SvgG, SvgNode);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_G_H