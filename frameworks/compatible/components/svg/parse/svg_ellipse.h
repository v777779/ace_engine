...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_ELLIPSE_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_ELLIPSE_H

#include "frameworks/compatible/components/svg/parse/svg_node.h"
#include "frameworks/compatible/components/svg/svg_ellipse_component.h"

namespace OHOS::Ace {

class SvgEllipse : public SvgNode {
    DECLARE_ACE_TYPE(SvgEllipse, SvgNode);
...
private:
    RefPtr<SvgEllipseComponent> component_;
};

} // namespace OHOS::Ace

#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_PARSE_SVG_ELLIPSE_H