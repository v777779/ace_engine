...
const std::shared_ptr<SvgFeMergeNodeAttribute> DEFAULT_SVG_FE_MERGE_NODE_ATTR =
    std::make_shared<SvgFeMergeNodeAttribute>();

void SvgFeMergeNodeDeclaration::InitSpecialized()
{
    AddSpecializedAttribute(DEFAULT_SVG_FE_MERGE_NODE_ATTR);
}

void SvgFeMergeNodeDeclaration::InitializeStyle()
{
