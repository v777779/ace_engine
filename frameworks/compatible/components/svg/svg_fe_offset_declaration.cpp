...
const std::shared_ptr<SvgFeOffsetAttribute> DEFAULT_SVG_FE_OFFSET_ATTR = std::make_shared<SvgFeOffsetAttribute>();

void SvgFeOffsetDeclaration::InitSpecialized()
{
    AddSpecializedAttribute(DEFAULT_SVG_FE_OFFSET_ATTR);
}
