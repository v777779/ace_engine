...
class RosenRenderSvgLine : public RenderSvgLine {
    DECLARE_ACE_TYPE(RosenRenderSvgLine, RenderSvgLine);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_SVG_ROSEN_RENDER_SVG_LINE_H
