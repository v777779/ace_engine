...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATILBE_COMPONENTS_RATING_RENDER_RATING_H
...
constexpr double DEFAULT_RATING_WIDTH = -1.0;

constexpr double DEFAULT_RATING_HEIGHT = -1.0;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATILBE_COMPONENTS_RATING_RENDER_RATING_H
