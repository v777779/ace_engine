...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_BADGE_LOADER
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_BADGE_LOADER

#include "compatible/components/component_loader.h"

namespace OHOS::Ace {

class BadgeLoader : public ComponentLoader {
public:
    BadgeLoader() = default;
    ~BadgeLoader() = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_BADGE_LOADER
