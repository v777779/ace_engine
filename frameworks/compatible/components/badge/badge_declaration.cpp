...
const std::shared_ptr<BadgeAttribute> DEFAULT_BADGE_ATTR = std::make_shared<BadgeAttribute>();
const std::shared_ptr<BadgeStyle> DEFAULT_BADGE_STYLE = std::make_shared<BadgeStyle>();
const std::shared_ptr<BadgeEvent> DEFAULT_BADGE_EVENT = std::make_shared<BadgeEvent>();

void BadgeDeclaration::InitSpecialized()
{
    AddSpecializedAttribute(DEFAULT_BADGE_ATTR);
    AddSpecializedStyle(DEFAULT_BADGE_STYLE);
    AddSpecializedEvent(DEFAULT_BADGE_EVENT);
}
