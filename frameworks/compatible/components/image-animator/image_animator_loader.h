...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_IMAGE_ANIMATOR_IMAGE_ANIMATOR_LOADER_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_IMAGE_ANIMATOR_IMAGE_ANIMATOR_LOADER_H

#include "compatible/components/component_loader.h"

namespace OHOS::Ace {
class ImageAnimatorLoader : public ComponentLoader {
public:
    ImageAnimatorLoader() = default;
    ~ImageAnimatorLoader() = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_IMAGE_ANIMATOR_IMAGE_ANIMATOR_LOADER_H