...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_LABEL_LOADER
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_LABEL_LOADER

#include "compatible/components/component_loader.h"

namespace OHOS::Ace {

class LabelLoader : public ComponentLoader {
public:
    LabelLoader() = default;
    ~LabelLoader() = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_LABEL_LOADER