...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_VIDEO_TEXTURE_COMPONENT_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_VIDEO_TEXTURE_COMPONENT_H
...
class ACE_FORCE_EXPORT TextureComponent : public RenderComponent {
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_VIDEO_TEXTURE_COMPONENT_H
