...
void VideoModelImpl::SetSrc(const std::string& src, const std::string& /* bundleName */,
...
void VideoModelImpl::SetPosterSourceByPixelMap(RefPtr<PixelMap>& pixMap)
{
    LOGW("Pixelmap is not supported.");
}
