...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIABLE_SWITCH_SWITCH_LOADER_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIABLE_SWITCH_SWITCH_LOADER_H
...
class SwitchLoader : public ComponentLoader {
public:
    SwitchLoader() = default;
    ~SwitchLoader() = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIABLE_SWITCH_SWITCH_LOADER_H