...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CANVAS_BRIDGE_JSI_CANVAS_BRIDGE_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CANVAS_BRIDGE_JSI_CANVAS_BRIDGE_H
...
public:
    ...
    void HandleJsContext(const shared_ptr<JsRuntime>& runtime, NodeId id, const std::string& args) override;
    void HandleToDataURL(const shared_ptr<JsRuntime>& runtime, NodeId id, const std::string& args) override;
    ...
    const shared_ptr<JsValue>& GetRenderContext() const override
    {
        return renderContext_;
    }

    const shared_ptr<JsValue>& GetDataURL() const override
    {
        return dataURL_;
    }
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CANVAS_BRIDGE_JSI_CANVAS_BRIDGE_H
