...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CANVAS_BRIDGE_JSI_OFFSCREEN_CANVAS_BRIDGE_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CANVAS_BRIDGE_JSI_OFFSCREEN_CANVAS_BRIDGE_H
...
public:
    ...
    shared_ptr<JsValue> GetBridge(const shared_ptr<JsRuntime>& runtime) override;

    int32_t GetBridgeId() const override
    {
        return bridgeId_;
    }
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CANVAS_BRIDGE_JSI_OFFSCREEN_CANVAS_BRIDGE_H