...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CANVAS_CANVAS_RENDERING_CONTEXT_2D_MODEL_IMPL_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CANVAS_CANVAS_RENDERING_CONTEXT_2D_MODEL_IMPL_H
...
public:
    ...
    ~CanvasRenderingContext2DModelImpl() override = default;
...
private:
    ...
    ACE_DISALLOW_COPY_AND_MOVE(CanvasRenderingContext2DModelImpl);
};
} // namespace OHOS::Ace::Framework
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_CANVAS_CANVAS_RENDERING_CONTEXT_2D_MODEL_IMPL_H
