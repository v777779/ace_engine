...
const std::shared_ptr<TextFieldAttribute> DEFAULT_TEXTFIELD_ATTR = std::make_shared<TextFieldAttribute>();
const std::shared_ptr<TextFieldStyle> DEFAULT_TEXTFIELD_STYLE = std::make_shared<TextFieldStyle>();
const std::shared_ptr<TextFieldEvent> DEFAULT_TEXTFIELD_EVENT = std::make_shared<TextFieldEvent>();
const std::shared_ptr<TextFieldMethod> DEFAULT_TEXTFIELD_METHOD = std::make_shared<TextFieldMethod>();
...
void TextFieldDeclaration::InitSpecialized()
{
    ...
    AddSpecializedAttribute(DEFAULT_TEXTFIELD_ATTR);
    AddSpecializedStyle(DEFAULT_TEXTFIELD_STYLE);
    AddSpecializedEvent(DEFAULT_TEXTFIELD_EVENT);
    AddSpecializedMethod(DEFAULT_TEXTFIELD_METHOD);
}
