...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATILBE_COMPONENTS_MARQUEE_RENDER_MARQUEE_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATILBE_COMPONENTS_MARQUEE_RENDER_MARQUEE_H
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATILBE_COMPONENTS_MARQUEE_RENDER_MARQUEE_H
