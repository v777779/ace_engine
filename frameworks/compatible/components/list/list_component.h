...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_LIST_LIST_COMPONENT_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_LIST_LIST_COMPONENT_H
...
inline constexpr  int32_t DEFAULT_COLUMN_EXTENT = 0;
inline constexpr  int32_t DEFAULT_COLUMN_COUNT = 0;
inline constexpr  double DEFAULT_GRID_HEIGHT = -1.0;
inline constexpr  double DEFAULT_GRID_WIDTH = -1.0;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_LIST_LIST_COMPONENT_H
