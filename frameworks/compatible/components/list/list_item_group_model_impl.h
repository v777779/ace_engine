...
#ifndef FRAMEWORKS_COMPATIBLE_COMPONENTS_LIST_LIST_ITEM_GROUP_MODEL_IMPL_H
#define FRAMEWORKS_COMPATIBLE_COMPONENTS_LIST_LIST_ITEM_GROUP_MODEL_IMPL_H
...
#endif // FRAMEWORKS_COMPATIBLE_COMPONENTS_LIST_LIST_ITEM_GROUP_MODEL_IMPL_H
