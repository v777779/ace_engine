...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_LIST_DOM_LIST_ITEM_GROUP_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_LIST_DOM_LIST_ITEM_GROUP_H

#include "compatible/components/list/list_item_group_component.h"
#include "core/components/theme/card_theme.h"
#include "frameworks/compatible/components/list/dom_list_item.h"

namespace OHOS::Ace::Framework {

// list-items-group attribute and style constants
extern const char DOM_LIST_ITEM_GROUP_EVENT_GROUPCLICK[];
extern const char DOM_LIST_ITEM_GROUP_EVENT_GROUPCOLLAPSE[];
extern const char DOM_LIST_ITEM_GROUP_EVENT_GROUPEXPAND[];
extern const char DOM_ID[];
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATIBLE_COMPONENTS_LIST_DOM_LIST_ITEM_GROUP_H
