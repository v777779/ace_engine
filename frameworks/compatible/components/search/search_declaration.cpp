...
const std::shared_ptr<SearchAttribute> DEFAULT_SEARCH_ATTR = std::make_shared<SearchAttribute>();
const std::shared_ptr<SearchStyle> DEFAULT_SEARCH_STYLE = std::make_shared<SearchStyle>();
const std::shared_ptr<SearchEvent> DEFAULT_SEARCH_EVENT = std::make_shared<SearchEvent>();
const std::shared_ptr<SearchMethod> DEFAULT_SEARCH_METHOD = std::make_shared<SearchMethod>();
...
{
    AddSpecializedAttribute(DEFAULT_SEARCH_ATTR);
    AddSpecializedStyle(DEFAULT_SEARCH_STYLE);
    AddSpecializedEvent(DEFAULT_SEARCH_EVENT);
    AddSpecializedMethod(DEFAULT_SEARCH_METHOD);
}
