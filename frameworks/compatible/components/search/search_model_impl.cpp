    ...
    const std::optional<std::u16string>& placeholder, const std::optional<std::string>& icon)
{
    ...
    auto textFieldTheme = TextFieldUtils::GetTheme<TextFieldTheme>();
    auto searchTheme = TextFieldUtils::GetTheme<SearchTheme>();
...
{
    TextFieldUtils::SetCopyOption(copyOptions);
}
