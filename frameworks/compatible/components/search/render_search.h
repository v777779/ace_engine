...
#ifndef FOUNDATION_ACE_FRAMEWORKS_COMPATILBE_COMPONENTS_SEARCH_RENDER_SEARCH_H
#define FOUNDATION_ACE_FRAMEWORKS_COMPATILBE_COMPONENTS_SEARCH_RENDER_SEARCH_H
...
#endif // FOUNDATION_ACE_FRAMEWORKS_COMPATILBE_COMPONENTS_SEARCH_RENDER_SEARCH_H
