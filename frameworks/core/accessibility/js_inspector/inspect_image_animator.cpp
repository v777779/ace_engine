...
#include "inspect_image_animator.h"

namespace OHOS::Ace::Framework {
InspectImageAnimator::InspectImageAnimator(NodeId nodeId, const std::string& nodeName) : InspectNode(nodeId, nodeName) {
}
...
void InspectImageAnimator::PackAttrAndStyle()
{
    ...
    attrs_.insert(std::make_pair("fillmode", "forwards"));
