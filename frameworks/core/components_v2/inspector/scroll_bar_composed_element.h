...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_V2_INSPECTOR_SCROLL_BAR_COMPOSED_ELEMENT_H
...
public:
    ...
    ~ScrollBarComposedElement() override = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_V2_INSPECTOR_SCROLL_BAR_COMPOSED_ELEMENT_H