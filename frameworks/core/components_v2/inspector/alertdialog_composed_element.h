...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_V2_INSPECTOR_ALERTDIALOG_COMPOSED_ELEMENT_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_V2_INSPECTOR_ALERTDIALOG_COMPOSED_ELEMENT_H
...
public:
    ...
    ~AlertDialogComposedElement() override = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_V2_INSPECTOR_ALERTDIALOG_COMPOSED_ELEMENT_H