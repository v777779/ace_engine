...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_V2_INSPECTOR_HYPERLINK_COMPOSED_ELEMENT_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_V2_INSPECTOR_HYPERLINK_COMPOSED_ELEMENT_H
...
public:
    ...
    ~HyperlinkComposedElement() override = default;
