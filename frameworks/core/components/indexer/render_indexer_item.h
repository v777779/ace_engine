...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_INDEXER_RENDER_INDEXER_ITEM_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_INDEXER_RENDER_INDEXER_ITEM_H
...
public:
    ...
    void UpdateItemBackground(const Color& color);
    ...
    void SetKeyCount(uint32_t keyCount)
    {
        keyCount_ = keyCount;
    }
...
private:
    ...
    double currentTextSize_ = 0.0;
    double defaultTextSize_ = 0.0;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_INDEXER_RENDER_INDEXER_ITEM_H
