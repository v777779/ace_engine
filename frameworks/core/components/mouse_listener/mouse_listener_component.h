...
public:
    ...
    void SetOnHoverId(const OnHoverMoveCallback& onHoverMoveId)
    {
        onHoverMoveId_ = std::make_unique<OnHoverMoveCallback>(onHoverMoveId);
    }
...
private:
    ...
    std::unique_ptr<OnHoverMoveCallback> onHoverMoveId_;
};
