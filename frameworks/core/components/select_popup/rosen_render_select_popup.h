...
class RosenRenderSelectPopup : public RenderSelectPopup {
    DECLARE_ACE_TYPE(RosenRenderSelectPopup, RenderSelectPopup);

public:
    RosenRenderSelectPopup() = default;
    ~RosenRenderSelectPopup() override = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SELECT_POPUP_ROSEN_RENDER_SELECT_POPUP_H
