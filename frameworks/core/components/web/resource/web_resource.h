...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_WEB_RESOURCE_WEB_RESOURCE_H
...
extern const char WEB_PARAM_VALUE[];
extern const char WEB_PARAM_EQUALS[];
extern const char WEB_PARAM_BEGIN[];
extern const char WEB_METHOD[];
extern const char WEB_EVENT[];
extern const char WEB_RESULT_FAIL[];
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_WEB_RESOURCE_WEB_RESOURCE_H
