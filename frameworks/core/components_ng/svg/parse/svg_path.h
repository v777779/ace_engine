...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_SVG_PARSE_SVG_PATH_H
...
class SvgPath : public SvgGraphic {
    DECLARE_ACE_TYPE(SvgPath, SvgGraphic);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_SVG_PARSE_SVG_PATH_H