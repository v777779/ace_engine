...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_SVG_SVG_TRANSFORM_UTILS_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_SVG_SVG_TRANSFORM_UTILS_H
...
class ACE_FORCE_EXPORT SvgTransform final {
public:
    ...
    static Matrix4 CreateMatrixFromMap(const std::map<std::string, std::vector<float>>& transform);
...
private:
    static void ApplyRotationPivot(Matrix4& mat, float x, float y);
};

} // namespace OHOS::Ace

#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_SVG_SVG_TRANSFORM_UTILS_H
