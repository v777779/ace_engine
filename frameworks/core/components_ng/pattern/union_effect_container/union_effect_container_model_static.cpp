...
RefPtr<FrameNode> UnionEffectContainerModelStatic::Create(int32_t nodeId)
{
...
void UnionEffectContainerModelStatic::SetUnionEffectContainerOptions(FrameNode* node,
    const std::optional<UnionEffectContainerOptions>& options)
{
