...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_SHEET_MINIMIZE_SHEET_MINIMIZE_OBJECT_H
...
class SheetMinimizeObject : public SheetObject {
    DECLARE_ACE_TYPE(SheetMinimizeObject, SheetObject);

public:
    SheetMinimizeObject(SheetType sheetType) : SheetObject(sheetType) {}
    ...
    {
        return newType != SheetType::SHEET_MINIMIZE;
    }
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_SHEET_MINIMIZE_SHEET_MINIMIZE_OBJECT_H