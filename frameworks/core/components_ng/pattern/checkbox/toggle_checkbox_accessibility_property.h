...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_CHECKBOX_TOGGLE_CHECKBOX_ACCESSIBILITY_PROPERTY_H
...
public:
    ToggleCheckBoxAccessibilityProperty() = default;
...
private:
    ACE_DISALLOW_COPY_AND_MOVE(ToggleCheckBoxAccessibilityProperty);
};
} // namespace OHOS::Ace::NG
