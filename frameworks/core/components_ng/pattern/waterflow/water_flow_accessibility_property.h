...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_WATERFLOW_WATER_FLOW_ACCESSIBILITY_PROPERTY_H
...
public:
    ...
    ~WaterFlowAccessibilityProperty() override = default;
...
private:
    ACE_DISALLOW_COPY_AND_MOVE(WaterFlowAccessibilityProperty);
};
} // namespace OHOS::Ace::NG

#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_WATERFLOW_WATER_FLOW_ACCESSIBILITY_PROPERTY_H
