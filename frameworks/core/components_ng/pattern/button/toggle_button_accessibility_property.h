...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_BUTTON_TOGGLE_BUTTON_ACCESSIBILITY_PROPERTY_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERNS_BUTTON_TOGGLE_BUTTON_ACCESSIBILITY_PROPERTY_H
...
public:
    ToggleButtonAccessibilityProperty() = default;

    ~ToggleButtonAccessibilityProperty() override = default;
