...
InputScene::InputScene(const sptr<Rosen::Session>& session) : SystemWindowScene(session)
{}

void InputScene::OnAttachToFrameNode()
{
...
uint32_t InputScene::GetWindowPatternType() const
{
    return static_cast<uint32_t>(WindowPatternType::INPUT_SCENE);
}
} // namespace OHOS::Ace::NG
