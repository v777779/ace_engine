...
#ifndef FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_MENU_BRIDGE_MENU_DYNAMIC_MODULE_H
#define FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_MENU_BRIDGE_MENU_DYNAMIC_MODULE_H

#include "core/common/dynamic_module.h"

namespace OHOS::Ace {

class MenuDynamicModule : public DynamicModule {
public:
    MenuDynamicModule() = default;
    ~MenuDynamicModule() = default;
...
#endif // FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_MENU_BRIDGE_MENU_DYNAMIC_MODULE_H