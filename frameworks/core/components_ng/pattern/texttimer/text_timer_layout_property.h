...
public:
    ...
    ACE_DEFINE_PROPERTY_ITEM_WITHOUT_GROUP(TextFontSizeSetByUser, bool, PROPERTY_UPDATE_MEASURE);
    ACE_DEFINE_PROPERTY_ITEM_WITHOUT_GROUP(TextFontWeightSetByUser, bool, PROPERTY_UPDATE_MEASURE);
    ACE_DEFINE_PROPERTY_ITEM_WITHOUT_GROUP(TextFontFamilySetByUser, bool, PROPERTY_UPDATE_MEASURE);
