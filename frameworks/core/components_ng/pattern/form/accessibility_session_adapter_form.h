...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_FORM_ACCESSIBILITY_SESSION_ADAPTER_FORM_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_FORM_ACCESSIBILITY_SESSION_ADAPTER_FORM_H
...
public:
    ...
    ~AccessibilitySessionAdapterForm() override = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_PATTERN_FORM_ACCESSIBILITY_SESSION_ADAPTER_FORM_H
