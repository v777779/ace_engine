...
{
    RefPtr<TaskRunnerAdapter> taskRunnerAdapterImpl = AceType::MakeRefPtr<TaskRunnerAdapterImpl>();
    taskRunnerAdapterImpl->Initialize(useCurrentEventRunner, threadName);
