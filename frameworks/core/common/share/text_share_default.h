...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMMON_SHARE_TEXT_SHARE_DEFAULT_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMMON_SHARE_TEXT_SHARE_DEFAULT_H

#include "interfaces/inner_api/ace/share/text_share_interface.h"

namespace OHOS::Ace {
class TextShareDefault : public TextShareInterface {
public:
    explicit TextShareDefault() {}
