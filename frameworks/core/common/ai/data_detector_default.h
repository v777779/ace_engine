...
#ifndef FOUNDATION_ACE_INTERFACE_INNERKITS_DATA_DETECTOR_DEFAULT_H
#define FOUNDATION_ACE_INTERFACE_INNERKITS_DATA_DETECTOR_DEFAULT_H

#include "interfaces/inner_api/ace/ai/data_detector_interface.h"

namespace OHOS::Ace {
class DataDetectorDefault : public DataDetectorInterface {
public:
    explicit DataDetectorDefault() {}
