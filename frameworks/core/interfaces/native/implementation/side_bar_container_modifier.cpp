...
{
#ifdef ACE_UNITTEST
    return GetSideBarContainerStaticModifier();
#else
    static const GENERATED_ArkUISideBarContainerModifier* cachedModifier = nullptr;
    if (cachedModifier == nullptr) {
        ...
        cachedModifier = reinterpret_cast<const GENERATED_ArkUISideBarContainerModifier*>(module->GetStaticModifier());
    }
