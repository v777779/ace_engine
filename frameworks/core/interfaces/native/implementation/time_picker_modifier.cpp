...
{
#ifdef ACE_UNITTEST
    return GetTimePickerStaticModifier();
#else
    static const GENERATED_ArkUITimePickerModifier* timePickerModifier = nullptr;
    if (timePickerModifier == nullptr) {
        ...
        timePickerModifier = reinterpret_cast<const GENERATED_ArkUITimePickerModifier*>(module->GetStaticModifier());
    }

    return timePickerModifier;
#endif
}
