...
{
    static const GENERATED_ArkUIArcAlphabetIndexerExtenderAccessor* cachedModifier = nullptr;

    if (cachedModifier == nullptr) {
        auto* module = DynamicModuleHelper::GetInstance().GetDynamicModule("Indexer");
        CHECK_NULL_RETURN(module, nullptr);
        cachedModifier = reinterpret_cast<const GENERATED_ArkUIArcAlphabetIndexerExtenderAccessor*>(
