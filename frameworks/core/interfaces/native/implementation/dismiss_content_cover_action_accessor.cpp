...
DismissContentCoverActionPeer g_dismissContentCoverPeer = {};
 
namespace OHOS::Ace::NG::GeneratedModifier {
namespace DismissContentCoverActionAccessor {
void DestroyPeerImpl([[maybe_unused]] Ark_DismissContentCoverAction peer)
{}
 
Ark_DismissContentCoverAction ConstructImpl()
{
    return &g_dismissContentCoverPeer;
}
                   ...
                   Ark_DismissReason reason)
{
    ...
    peer->reason = Converter::OptConvert<BindSheetDismissReason>(reason)
