...
{
    static const GENERATED_ArkUISliderModifier* cachedModifier = nullptr;
    if (!cachedModifier) {
#ifdef ARKUI_CAPI_UNITTEST
        cachedModifier = GeneratedModifier::GetSliderStaticModifier();
#else
        auto* module = DynamicModuleHelper::GetInstance().GetDynamicModule("Slider");
        CHECK_NULL_RETURN(module, nullptr);
        cachedModifier = reinterpret_cast<const GENERATED_ArkUISliderModifier*>(module->GetStaticModifier());
#endif
    }
