...
#include "content_transition_effect_peer_impl.h"
...
{
    return PeerUtils::CreatePeer<ContentTransitionEffectPeer>();
}
...
{
    ContentTransitionEffectPeer* peer = nullptr;
    peer = PeerUtils::CreatePeer<ContentTransitionEffectPeer>();
