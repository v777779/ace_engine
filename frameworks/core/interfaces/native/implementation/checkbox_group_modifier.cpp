...
{
#ifdef ACE_UNITTEST
    return GetCheckboxGroupStaticModifier();
#else
    static const GENERATED_ArkUICheckboxGroupModifier* cachedModifier = nullptr;
    if (cachedModifier == nullptr) {
        ...
        cachedModifier = reinterpret_cast<const GENERATED_ArkUICheckboxGroupModifier*>(module->GetStaticModifier());
    }
