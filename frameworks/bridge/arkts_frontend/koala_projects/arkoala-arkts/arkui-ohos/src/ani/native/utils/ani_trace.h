...
#ifndef KOALA_PROJECTS_ARKOALA_ARKTS_ARKUI_OHOS_ANI_NATIVE_ANI_TRACE
#define KOALA_PROJECTS_ARKOALA_ARKTS_ARKUI_OHOS_ANI_NATIVE_ANI_TRACE
...
public:
    ...
    static void AsyncTraceEnd(ani_env* env, [[maybe_unused]] ani_object aniClass,
        ani_string aniTraceName, ani_int taskId);
};

} // namespace OHOS::Ace::Ani

#endif // KOALA_PROJECTS_ARKOALA_ARKTS_ARKUI_OHOS_ANI_NATIVE_ANI_TRACE
