...
#ifndef KOALA_PROJECTS_ARKOALA_ARKTS_ARKUI_OHOS_GESTURE_EVENT_UIOBSERVER_MODULE_H
#define KOALA_PROJECTS_ARKOALA_ARKTS_ARKUI_OHOS_GESTURE_EVENT_UIOBSERVER_MODULE_H
