...
#ifndef KOALA_PROJECTS_ARKOALA_ARKTS_ARKUI_OHOS_ANI_NATIVE_VISUAL_EFFECT_VISUAL_EFFECT_MODULE_H
#define KOALA_PROJECTS_ARKOALA_ARKTS_ARKUI_OHOS_ANI_NATIVE_VISUAL_EFFECT_VISUAL_EFFECT_MODULE_H

#include "ani.h"

namespace OHOS::Ace::Ani {
ani_long ExtractorsToRectShapePtr(ani_env* env, ani_object aniClass, ani_object obj);
ani_object ExtractorsFromRectShapePtr(ani_env* env, ani_object aniClass, ani_long ptr);
ani_long ExtractorsToCircleShapePtr(ani_env* env, ani_object aniClass, ani_object obj);
ani_object ExtractorsFromCircleShapePtr(ani_env* env, ani_object aniClass, ani_long ptr);
