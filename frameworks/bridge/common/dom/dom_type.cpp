...
const char DOM_TEXT_DECORATION_STYLE[] = "textDecorationStyle";
...
const char DOM_TEXT_DECORATION_STYLE_SOLID[] = "solid";
const char DOM_TEXT_DECORATION_STYLE_DOUBLE[] = "double";
const char DOM_TEXT_DECORATION_STYLE_DOTTED[] = "dotted";
const char DOM_TEXT_DECORATION_STYLE_DASHED[] = "dashed";
const char DOM_TEXT_DECORATION_STYLE_WAVY[] = "wavy";
const char DOM_TEXT_DECORATION_STYLE_INITIAL[] = "initial";
const char DOM_TEXT_DECORATION_STYLE_INHERIT[] = "inherit";
...
const char DOM_CATCH_BUBBLE_SWIPE[] = "catchbubbleswipe";
...
const char DOM_CATCH_BUBBLE_DOUBLE_CLICK[] = "catchbubbledoubleclick";
const char DOM_LONG_PRESS[] = "longpress";
const char DOM_CATCH_BUBBLE_LONG_PRESS[] = "catchbubblelongpress";
