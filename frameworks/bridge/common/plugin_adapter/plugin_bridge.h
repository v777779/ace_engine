...
#ifndef FOUNDATION_ACE_FRAMEWORKS_BRIDGE_COMMON_PLUGIN_ADAPTER_PLUGIN_BRIDGE_H
#define FOUNDATION_ACE_FRAMEWORKS_BRIDGE_COMMON_PLUGIN_ADAPTER_PLUGIN_BRIDGE_H
