...
public:
    static void JSBind(BindingTarget globalObj);
    void SetFromIndex(const JSCallbackInfo& args);
    void GetFromIndex(const JSCallbackInfo& args);
    void SetToIndex(const JSCallbackInfo& args);
...
#endif // FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_ENGINE_FUNCTION_JS_TABS_FUNCTION_H
