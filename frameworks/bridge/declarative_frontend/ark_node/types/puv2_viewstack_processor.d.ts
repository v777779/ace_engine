 ...
 *
 * Implementation in C++ and exposed to JS
 *
...
declare class ViewStackProcessor {
  ...
  // this is used for first render case
   ...
   * JS signature: MakeUniqueId() : number
   */
   ...
   */
  public static UsesNewPipeline(): boolean;

  // Gets the frame node with tag and elmtId then pushes to the view stack.
  public static GetAndPushFrameNode(tag: string, elmtId: number): void;

  // move deleted elmtIds from ElementRegistry in C++ to the caller
  public static moveDeletedElmtIds(elmtIds: Array<number>): void;
