...
#ifndef FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_JS_VIEW_JS_PERSISTENT_H
#define FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_JS_VIEW_JS_PERSISTENT_H
...
public:
    ...
    static void DestructorCallback(JSPersistent* obj);

    static void JSBind(BindingTarget globalObj);

private:
    std::string dbFile_;
    bool needCrossThread_ = false;
};

} // namespace OHOS::Ace::Framework
#endif // FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_JS_VIEW_JS_PERSISTENT_H