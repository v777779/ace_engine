...
export class ValueAssignTest implements ITestFile {
  ...
  public testValueAssign(): void {
    ...
    console.log('PerformanceTest case: valueAssign', result);
    lt(result, 5); // val['key'] = value
  }
