...
{
    return ViewStackModel::GetInstance()->StartGetAccessRecordingFor(elmtId);
}

int32_t CJViewStackProcessor::GetElmtIdToAccountFor()
{
    return ViewStackModel::GetInstance()->GetElmtIdToAccountFor();
}

void CJViewStackProcessor::StopGetAccessRecording()
{
