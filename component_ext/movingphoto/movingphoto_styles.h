...
#ifndef COMPONENT_EXT_MOVING_PHOTO_MOVING_PHOTO_STYLES_H
#define COMPONENT_EXT_MOVING_PHOTO_MOVING_PHOTO_STYLES_H
...
struct MovingPhotoStyle {
    ACE_DEFINE_PROPERTY_GROUP_ITEM(VideoSource, int32_t);
    ACE_DEFINE_PROPERTY_GROUP_ITEM(ImageSourceInfo, ImageSourceInfo);
...
#endif // COMPONENT_EXT_MOVING_PHOTO_MOVING_PHOTO_STYLES_H
