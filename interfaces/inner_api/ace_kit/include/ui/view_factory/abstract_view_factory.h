...
#ifndef FOUNDATION_ACE_INTERFACES_INNER_API_ACE_KIT_INCLUDE_VIEW_FACTORY_ABSTRACT_VIEW_FACTORY_H
#define FOUNDATION_ACE_INTERFACES_INNER_API_ACE_KIT_INCLUDE_VIEW_FACTORY_ABSTRACT_VIEW_FACTORY_H
