 ...
 * @tc.type: FUNC
 */
HWTEST_F(ReplaceSymbolEffectAccessorTest, getScopeTest, TestSize.Level1)
{
    ASSERT_NE(accessor_->getScope, nullptr);
    const std::vector<std::tuple<Ark_ReplaceSymbolEffect, std::optional<OHOS::Ace::ScopeType>>> testPlan {
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ReplaceSymbolEffectAccessorTest, setScopeTest, TestSize.Level1)
{
