...
void TextBasesMin::onClickFunc(const BaseEventInfo* info) {};

void TextBasesMin::onRemoteMessage() {};

void TextBasesMin::OnDragDropFunction(const RefPtr<OHOS::Ace::DragEvent>&, const std::string&) {};

DragDropBaseInfo TextBasesMin::OnDragStartFunction(const RefPtr<OHOS::Ace::DragEvent>&, const std::string&)
{
    DragDropBaseInfo temp;
    return temp;
}

void TextBasesMin::SuppressMockParagraph()
{
...
std::pair<RefPtr<FrameNode>, RefPtr<TextPattern>> TextBasesMin::Init()
{
...
void TextBasesMin::TestUpdateScenario(const RefPtr<TextPattern>& pattern)
{
...
void TextBasesMin::ConstructSpanItemList1(std::list<RefPtr<SpanItem>>& spans)
{
...
void TextBasesMin::SetUpTestSuite()
{
...
void TextBasesMin::TearDownTestSuite()
{
    MockPipelineContext::TearDown();
    MockContainer::TearDown();
}

void TextBasesMin::SetUp()
{
    MockParagraph::GetOrCreateMockParagraph();
}

void TextBasesMin::TearDown()
{
    MockParagraph::TearDown();
}

RefPtr<SpanNode> TextBasesMin::CreateSpanNodeWithSetDefaultProperty(const std::u16string& content)
{
...
RefPtr<ImageSpanNode> TextBasesMin::CreateImageSpanNode(const ImageSpanNodeProperty& property)
{
...
RefPtr<FrameNode> TextBasesMin::CreateTextParagraph(const std::u16string& createValue, const TestProperty& testProperty)
{
...
void TextBasesMin::SetContentModifier(TextContentModifier& textContentModifier)
{
...
void TextBasesMin::SetPaintMethodModifier(TextPaintMethod& textPaintMethod)
{
...
void TextBasesMin::UpdateTextLayoutProperty(RefPtr<TextLayoutProperty> textLayoutProperty)
{
