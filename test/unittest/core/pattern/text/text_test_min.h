...
#ifndef FOUNDATION_ACE_TEST_UNITTEST_CORE_PATTERN_TEXT_TEXT_TEST_MIN_H
#define FOUNDATION_ACE_TEST_UNITTEST_CORE_PATTERN_TEXT_TEXT_TEST_MIN_H
...
class TextBasesMin : public TestNG {
public:
...
#endif // FOUNDATION_ACE_TEST_UNITTEST_CORE_PATTERN_TEXT_TEXT_TEST_MIN_H