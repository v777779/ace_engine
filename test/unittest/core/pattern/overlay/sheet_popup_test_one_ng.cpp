...
class SheetPopupTestOneNg : public testing::Test {
public:
...
void SheetPopupTestOneNg::SetUpTestCase()
{
...
void SheetPopupTestOneNg::TearDownTestCase()
{
    MockPipelineContext::TearDown();
    MockContainer::TearDown();
}

RefPtr<FrameNode> SheetPopupTestOneNg::InitTargetNodeEnv(RefPtr<FrameNode>& rootNode, const SizeF& rootSize,
    const OffsetF& rootOffset, const SizeF& targetSize, const OffsetF& targetOffset)
{
...
void SheetPopupTestOneNg::CreateSheetStyle(SheetStyle& sheetStyle, const Dimension& width, const Dimension& height)
{
...
void SheetPopupTestOneNg::CreateSheetBuilder(float builderHeight, float titleHeight)
{
...
void SheetPopupTestOneNg::InitSheetAndWrapperLayoutInfo(
    const RefPtr<FrameNode>& sheetPageNode, const RefPtr<FrameNode>& sheetWrapperNode,
    RefPtr<SheetPresentationLayoutAlgorithm>& sheetPageLayoutAlgorithm,
    RefPtr<SheetWrapperLayoutAlgorithm>& sheetWrapperLayoutAlgorithm)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SheetPopupTestOneNg, GetPopupStyleSheetOffset001, TestSize.Level1)
{
    /**
     * @tc.steps: step1: create root and target node, init builder func
     * @tc.expected: targetNode != nullptr
     */
    SheetPopupTestOneNg::SetUpTestCase();
     ...
     */
    SheetPopupTestOneNg::TearDownTestCase();
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SheetPopupTestOneNg, GetPopupStyleSheetOffset002, TestSize.Level1)
{
    /**
     * @tc.steps: step1: create root and target node, init builder func
     * @tc.expected: targetNode != nullptr
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SheetPopupTestOneNg, GetPopupStyleSheetOffset003, TestSize.Level1)
{
    /**
     * @tc.steps: step1: create root and target node, init builder func
     * @tc.expected: targetNode != nullptr
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SheetPopupTestOneNg, GetPopupStyleSheetOffset004, TestSize.Level1)
{
    /**
     * @tc.steps: step1: create root and target node, init builder func
     * @tc.expected: targetNode != nullptr
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SheetPopupTestOneNg, GetOffsetInAvoidanceRule001, TestSize.Level1)
{
    /**
 ...
 * @tc.type: FUNC
 */
HWTEST_F(SheetPopupTestOneNg, GetOffsetWithBottomLeft001, TestSize.Level1)
{
    /**
     * @tc.steps: step1: create root and target node, init builder func, set api version 12
     * @tc.expected: targetNode != nullptr
