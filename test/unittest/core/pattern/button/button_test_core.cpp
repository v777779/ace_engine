...
class ButtonFunctionTestCore : public ButtonTestBase {};
class ButtonPropertyTestCore : public ButtonTestBase {};
class ButtonEventTestCore : public ButtonTestBase {};
class ToggleButtonTestCore : public ButtonTestBase {};
class ButtonContentModifierTestCore : public ButtonTestBase {};
class ButtonContentModifierTwoTestCore : public ButtonTestBase {};
class ButtonModelStaticTestCore : public ButtonTestBase {};
