...
class UnionEffectContainerTestCore : public UnionEffectContainerTestBase {};

// Placeholder test to ensure compilation
HWTEST_F(UnionEffectContainerTestCore, UnionEffectContainerTestPlaceholder, TestSize.Level1)
{
    EXPECT_TRUE(true);
}
