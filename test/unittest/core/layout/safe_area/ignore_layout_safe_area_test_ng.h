...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_TEST_LAYOUT_IGNORE_LAYOUT_SAFE_AREA_TEST_NG_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_NG_TEST_LAYOUT_IGNORE_LAYOUT_SAFE_AREA_TEST_NG_H
