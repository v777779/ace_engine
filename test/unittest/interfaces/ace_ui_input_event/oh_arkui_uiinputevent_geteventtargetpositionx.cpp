...
HWTEST_F(UIInputEventTest, OH_ArkUI_UIInputEvent_GetEventTargetPositionX_Null, TestSize.Level0)
{
    float result = OH_ArkUI_UIInputEvent_GetEventTargetPositionX(nullptr);
    EXPECT_FLOAT_EQ(result, 0.0f) << "event is nullptr, should return 0.0f";
}

HWTEST_F(UIInputEventTest, OH_ArkUI_UIInputEvent_GetEventTargetPositionX_AllCases, TestSize.Level0)
{
    ArkUITouchEvent touchEvent = {};
    touchEvent.targetPositionX = 11.1f;

    OHOS::Ace::TouchEvent baseTouchEvent = {};
    baseTouchEvent.targetPositionX = 12.2f;

    ArkUIAxisEvent axisEvent = {};
    axisEvent.targetPositionX = 13.3f;

    OHOS::Ace::AxisEvent baseAxisEvent = {};
    baseAxisEvent.targetPositionX = 14.4f;

    ArkUIMouseEvent mouseEvent = {};
    mouseEvent.targetPositionX = 15.5f;

    ArkUIHoverEvent hoverEvent = {};
    hoverEvent.targetPositionX = 16.6f;

    ArkUIClickEvent clickEvent = {};
    clickEvent.targetPositionX = 17.7f;

    ArkUIFocusAxisEvent focusAxisEvent = {};
    focusAxisEvent.targetPositionX = 18.8f;
    ...
    for (const auto& test : testCases) {
        float result = OH_ArkUI_UIInputEvent_GetEventTargetPositionX(&test.first);
