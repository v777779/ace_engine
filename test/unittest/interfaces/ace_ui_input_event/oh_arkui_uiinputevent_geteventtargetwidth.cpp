...
HWTEST_F(UIInputEventTest, OH_ArkUI_UIInputEvent_GetEventTargetWidth_Null, TestSize.Level0)
{
    float result = OH_ArkUI_UIInputEvent_GetEventTargetWidth(nullptr);
    EXPECT_FLOAT_EQ(result, 0.0f) << "event is nullptr, should return 0.0f";
}

HWTEST_F(UIInputEventTest, OH_ArkUI_UIInputEvent_GetEventTargetWidth_AllCases, TestSize.Level0)
{
    ArkUITouchEvent touchEvent = {};
    touchEvent.width = 11.1f;

    OHOS::Ace::TouchEvent baseTouchEvent = {};
    baseTouchEvent.width = 12;

    ArkUIAxisEvent axisEvent = {};
    axisEvent.width = 13.3f;

    OHOS::Ace::AxisEvent baseAxisEvent = {};
    baseAxisEvent.width = 14.4f;

    ArkUIMouseEvent mouseEvent = {};
    mouseEvent.width = 15.5f;

    ArkUIHoverEvent hoverEvent = {};
    hoverEvent.width = 16.6f;

    ArkUIClickEvent clickEvent = {};
    clickEvent.width = 17.7f;

    ArkUIFocusAxisEvent focusAxisEvent = {};
    focusAxisEvent.width = 18.8f;

    std::vector<std::pair<ArkUI_UIInputEvent, float>> testCases = {
        { { ARKUI_UIINPUTEVENT_TYPE_TOUCH, C_TOUCH_EVENT_ID, &touchEvent },      11.1f },
        { { ARKUI_UIINPUTEVENT_TYPE_TOUCH, TOUCH_EVENT_ID, &baseTouchEvent },   12 },
        ...
        { { ARKUI_UIINPUTEVENT_TYPE_TOUCH, C_TOUCH_EVENT_ID, nullptr },         0 },
    ...
    for (const auto& test : testCases) {
        float result = OH_ArkUI_UIInputEvent_GetEventTargetWidth(&test.first);
