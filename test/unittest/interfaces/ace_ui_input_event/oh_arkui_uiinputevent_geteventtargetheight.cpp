...
HWTEST_F(UIInputEventTest, OH_ArkUI_UIInputEvent_GetEventTargetHeight_Null, TestSize.Level0)
{
    float result = OH_ArkUI_UIInputEvent_GetEventTargetHeight(nullptr);
    EXPECT_FLOAT_EQ(result, 0.0f) << "event is nullptr, should return 0.0f";
}

HWTEST_F(UIInputEventTest, OH_ArkUI_UIInputEvent_GetEventTargetHeight_AllCases, TestSize.Level0)
{
    ArkUITouchEvent touchEvent = {};
    touchEvent.height = 10.1f;

    OHOS::Ace::TouchEvent baseTouchEvent = {};
    baseTouchEvent.height = 11;

    ArkUIAxisEvent axisEvent = {};
    axisEvent.height = 12.3f;

    OHOS::Ace::AxisEvent baseAxisEvent = {};
    baseAxisEvent.height = 13.4f;

    ArkUIMouseEvent mouseEvent = {};
    mouseEvent.height = 14.5f;

    ArkUIHoverEvent hoverEvent = {};
    hoverEvent.height = 15.6f;

    ArkUIClickEvent clickEvent = {};
    clickEvent.height = 16.7f;

    ArkUIFocusAxisEvent focusAxisEvent = {};
    focusAxisEvent.height = 17.8f;
    ...
    for (const auto& test : testCases) {
        float result = OH_ArkUI_UIInputEvent_GetEventTargetHeight(&test.first);
